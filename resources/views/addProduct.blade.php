            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        type="text" placeholder="Enter product name" value="{{ $product->product_name
                        }}">
                        @error('product_name')
            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('product_price')
                        is-invalid @enderror" required id="product_price" name="product_price"
                        type="text" placeholder="Enter product price" value="{{ $product->price }}">
                        @error('product_price')
                        <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="form-group">
                <label for="img">Upload Product Image</label>
                    <div class="row">
                        ...
                        src="{{asset('/img/'.$product->img)}}" alt="preview image" style="height:
                        200px; width: 200px; object-fit: cover;" class=" mb-2">
                        <input class=" form-control @error('img')
                        is-invalid @enderror " type="file" name="img" value="" id="img">
                        @error('img')
                        <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                        </span>
