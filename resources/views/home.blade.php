...
@section('content')
<div class="coatiner-fluid hero-section">
    <div class="container-fluid hero-section d-flex align-items-center">
        <div class="col-4 text-center m-auto bg-black bg-opacity-50 text-white p-5 ">
            ...
            <p class="mb-5">Lorem ipsum dolor sit amet consectetur. Commodo pulvinar
            tortor nunc lectus. Vitae vitae tortor urna sodales mi. </p>
